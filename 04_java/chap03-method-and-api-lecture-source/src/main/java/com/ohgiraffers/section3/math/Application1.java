...
public class Application1 {
    public static void main(String[] args) {
        ...
        //운영체제가 프로그래밍 언어가 제공하는 기능을 제어할 수 있도ㅗㄱ 만든 인터페이스를 뜻한다.
        //우리가 구현할 수 없거나 구현하기 번거로운 기능들을 JDK를 설치하면 사용할 수 있도록 제공해놓은 소스코드를 의미한다.
        //누가 작성해 놓은 소스코드이니 가져다 쓰는 방법을 본다는 말이다. 모든 코드를 우리가 다 외울 수 없으니 API문서를 별로도 제공해줄고 있다.
