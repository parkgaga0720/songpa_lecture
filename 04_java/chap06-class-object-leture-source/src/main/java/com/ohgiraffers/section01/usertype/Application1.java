...
public class Application1 {
    public static void main(String[] args) {
        ...
        //지금까지 자바에서 제공되는 자료들을 히급하는 자료형에 대해 학습했다.
        //이제 조듬 더 복잡한 자료를 취급할 수 있는 방법을 배워보자
        ...
        //위의 회원정보들을 연속된 메모리 주소에서 사용하도록 heap에 공간을 만들어보자

        Member member = new Member();

        //생성된 인스터스의 초기값 확인하기
        //이렇게 객체를 생성하고 나면 서로 다른 자료형들을 하나의 member라는 이름으로 관리 할 수 있도록 공간을 생성한 것이다.
        //heap에 생성되기 때문에 jvm 기본값으로 초기화 된다.

        //필드에 접근하기 위해서는 레퍼런스변수명.필드명으로 접근한다.
        //'.'은 참조 연산자라ㄱ 하는데, 레퍼런스 변수가 참고하고 있는 주소로 접근한다는 의미를 가진다.
