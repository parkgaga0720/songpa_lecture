...
public class Application {
    public static void main(String[] args) {
        ...
        //static
        //정적 메모리 영역에 프로그램이 start 될때 할당을 하는 키워드이다.
        //인스턴스를 생성하지 않고도 사용할 클래스의 멤버(필드, 메소드)에 지정할 수 있다.
        //여러 인슨턴스가 공유해서 사용할 목정의 공간이다.
        //하지만 static 키워드의 남발은 유지보수와 추적이 힘든 코드를 작성하는 피해야할 방식이다.
        //명확한 목적이 존재하니 않는 이상 static 키워드 사용은 자제하자
        ...
        //하지만 static 필드의 경우에는 클래스변수 자체가 프로그램을 종료할 때까지 유지되고 있기 때문에 값을 유지하고 있따.
        ...
        smt.nonStaticMethod();
        //static method는 정적 영역에 두고 인스턴스를 생성하지 않고 호출할 목적으로 만들기 때문에 static 메소드를 호출하는 방식으로 호출해야 한다
