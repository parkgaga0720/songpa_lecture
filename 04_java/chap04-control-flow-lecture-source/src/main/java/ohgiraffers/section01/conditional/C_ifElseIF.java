...
public class C_ifElseIF {
    public void testSimpleIfElseIfStatement() {
        //if-else-if 문 단독 사용헤 대한 흐름을 이해하고 적용할 수 있다.

        //[if-esle-if 표현식]
        // if(조건식 1){
        //      조건식 1이 true일 때 실행할 명령문;
        //} else if(조건식 2) {
        //      조건식 1이 false이고 조건식 2가 true일때 실행할 명령문;
        //} else {
        ...
        if (answer == 1) {
            ...
            System.out.println("너 정직하구나~ 이 세개의 도끼를 다 주겠다..");
        }
    ...
    public void testNestedIfElseIfStatement() {
        //중첩된 if-else-if 의 흐름을 알 수 있다.

        //문제 6
        //ohgiraffers 대학의 김교수는 학생들 시험 성적을 수기로 계산해서 학점 등급을 매기는 채점방식을 사용하고 있었다.
        // 90점 이상이면 'A', 80점 이상이면 'B', 70점 이상이면 'C', 60점 이상미연 'D'를
        // 60점 미만일 경우에는 'F'를 학점 등급으로 하는 기준이다.
        //추가로 각등급의 중간점수인 경우 +를 붙여서 등급을 세분화 하다보니 복잡하다.
